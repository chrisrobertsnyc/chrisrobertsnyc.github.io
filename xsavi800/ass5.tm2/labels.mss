...
@serif: 'Magda Offc Pro Regular', @fallback;
@serif_md: 'Magda Offc Pro Regular', @fallback;
@serif_bd: 'Magda Offc Pro Bold', @fallback;
@serif_it: 'Magda Offc Pro Light', @fallback;
//sans
@sans: 'Open Sans Regular', @fallback;
@sans_md: 'Open Sans Regular', @fallback;
@sans_bd: 'Open Sans Bold', @fallback;
@sans_bk: 'Open Sans Extrabold', @fallback;
